function [done]=Step8_Decoding_f_pBlk_iterations(subject,Main_analysis_directory,Action,Trial_type,Decod_instead_of_Corr,searchlighting)
...
elseif Action>1
    ...
    if Trial_type==1
        save(fullfile(Directory_for_working,num2str(csub,'S%03d'),'/',Beta_folder_name,'/',['RSA_',Iter,'CBU_',dec,SL,'.mat']),'RSA_results');
    elseif Trial_type==2
        save(fullfile(Directory_for_working,num2str(csub,'S%03d'),'/',Beta_folder_name_scnd,'/',['RSA_',Iter,'Cor_Incor_',dec,SL,'.mat']),'RSA_results');
    elseif Trial_type==3
        save(fullfile(Directory_for_working,num2str(csub,'S%03d'),'/',Beta_folder_name,'/',['RSA_',Iter,'CBU_Cue_Color_',dec,SL,'.mat']),'RSA_results');
    elseif Trial_type==4
    ...
    elseif Trial_type==11
        save(fullfile(Directory_for_working,num2str(csub,'S%03d'),'/',Beta_folder_name,'/',['RSA_',Iter,'CBU_Resp_InOut_opst_Colrs',dec,SL,'.mat']),'RSA_results');
    elseif Trial_type==12
