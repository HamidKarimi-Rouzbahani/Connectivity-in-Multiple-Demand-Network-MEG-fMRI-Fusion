...
for Trial_type=[10 1 3 11]
    ...
    % 1 (perfect)= stim periph coding; columns: rule1inner rule1outer rule2inner rule2outer
    ...
    addpath('/group/woolgar-lab/projects/Hamid/Projects/MD/MEG')
    if Trial_type==1
        %
        %     load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_RDM_decoding4.mat']);
        %     sampling_time=25;
        
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_RDM_decoding4_5ms.mat']);
        sampling_time=5;
    ...
    elseif Trial_type==3
        %     load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_cue_coding_RDM.mat']);
        %     sampling_time=5;
        
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_cue_coding_RDM_dec.mat']);
        sampling_time=5;
        
    elseif Trial_type==4
        %     load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_stm_coding_RDM.mat']);
        %     sampling_time=5;
        
        % the following is broken at the moment
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_stm_coding_RDM_dec.mat']);
        sampling_time=25;
        
    elseif Trial_type==5
        
        %     load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Stm_coding_Clpsd_cue_colors_RDM.mat']);
        %     sampling_time=5;
        
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Stm_coding_Clpsd_cue_colors_RDM_dec.mat']);
        sampling_time=25;
        
    elseif Trial_type==6
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Stm_side_coding_Clpsd_cue_colors_RDM_dec.mat']);
        sampling_time=25;
        sampling_time=5;
        
        
    elseif Trial_type==7
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Resp_coding_RDM_decoding.mat']);
        sampling_time=5;
        
    elseif Trial_type==8
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Resp_coding_acrs_rules_RDM_decoding.mat']);
        sampling_time=5;
        
    elseif Trial_type==9
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Resp_coding_acrs_opst_col_RDM_decoding.mat']);
        sampling_time=5;
        
    elseif Trial_type==10
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_RDM_decoding4_5ms_side_dec.mat']);
        sampling_time=5;
        
    elseif Trial_type==11
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Resp_coding_InOut_acrs_opst_col_RDM_decoding.mat']);
        sampling_time=5;
        
    elseif Trial_type==12
        load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/Subjects_Average_',Stim_Resp,'_aligned_Resp_coding_InOut_acrs_opst_col2_RDM_decoding.mat']);
        sampling_time=5;        
    end
    ...
    load(['/group/woolgar-lab/projects/Hamid/Projects/MD/MEG/RDM_models_',num2str(NoC),'.mat'])
    if Trial_type==4
        %     % inner vs outer
        %         S_model_cor=nan(NoC);
        %         S_model_cor(1,4)=0;
    ...
    plots=plot(Times,smooth(correl,smoothing_rate),'linewidth',2);
    ...
    for region=regions_order_to_read
        ...
        for time=1:length(Times)
            ...
            %         if Trial_type==3
            %             data(time,c)=R_sqrd_rule(time,region);
            %         elseif Trial_type>3
            %             data(time,c)=R_sqrd_stim(time,region);
            %         end
            
            if    Trial_type==3
                Correlations_all_out(time,region)=partialcorr(RDM_MEG,RDM_fMRI,[RDM_model_Rule],'type','Pearson');
                Correlations_all_expt_rule_out(time,region)=corr(RDM_MEG,RDM_fMRI,'type','Pearson');
                R_sqrd(time,region)=Correlations_all_expt_rule_out(time,region)-Correlations_all_out(time,region);
                data(time,c,tt)=R_sqrd(time,region);
                
            elseif Trial_type==1 || Trial_type>3
                Correlations_all_out(time,region)=partialcorr(RDM_MEG,RDM_fMRI,[RDM_model_Stim],'type','Pearson');
                Correlations_all_expt_stim_out(time,region)=corr(RDM_MEG,RDM_fMRI,'type','Pearson');
                R_sqrd(time,region)=Correlations_all_expt_stim_out(time,region)-Correlations_all_out(time,region);
                data(time,c,tt)=R_sqrd(time,region);
            end
...
for tt=1:4
    cors_summerizedNew(:,:,tt)=[data(:,1,tt) nanmean(data(:,2:3,tt),2) nanmean(data(:,4:5,tt),2),...
        nanmean(data(:,6:7,tt),2) nanmean(data(:,8:9,tt),2) nanmean(data(:,10:11,tt),2)];
end
legends={'Stim Side','Stim Periph','Rule','Resp'};
% Regions_summereized={'Visual',''};
c=0;
