...
if Action==3
    load(['D:\Hamid\Postdoc\MD\MEG\Subjects_Average_',Stim_Resp,'_aligned_RDM_decoding.mat']);
elseif Action==4
...
for region=regions_order_to_read
    ...
    RDM_model_Stim=reshape(S_model_periph_cor,[NoC*NoC 1]);
    ...
    cors(1,c)=corr(RDM_fMRI,RDM_model_Stim,'type','Spearman');
    cors(2,c)=corr(RDM_fMRI,RDM_model_Rule,'type','Spearman');
    
%     cors(1,c)=partialcorr(RDM_fMRI,RDM_model_Stim,RDM_model_Stim_periph,'type','Spearman');
%     cors(2,c)=partialcorr(RDM_fMRI,RDM_model_Rule,RDM_model_Stim_periph,'type','Spearman');
end
...
%     correl(1,time)=corr(reshape(MEG_RDM(:,:,time),[NoC*NoC 1]),reshape(S_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');
%     correl(2,time)=corr(reshape(MEG_RDM(:,:,time),[NoC*NoC 1]),reshape(R_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');
    
    correl(1,time)=partialcorr(reshape(MEG_RDM(:,:,time),[NoC*NoC 1]),reshape(S_model_periph_cor,[NoC*NoC 1]),reshape(R_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');
    correl(2,time)=partialcorr(reshape(MEG_RDM(:,:,time),[NoC*NoC 1]),reshape(R_model_cor,[NoC*NoC 1]),reshape(S_model_periph_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');
%     
%     correl(1,time)=corr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(S_model_err,[NoC*NoC 1]),'type','Spearman','rows','complete');
%     correl(2,time)=corr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(R_model_err,[NoC*NoC 1]),'type','Spearman','rows','complete');
%     correl(3,time)=corr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(SR_model_err,[NoC*NoC 1]),'type','Spearman','rows','complete');


% correl(1,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(S_model_err,[NoC*NoC 1]),reshape(S_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');
% correl(2,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(R_model_err,[NoC*NoC 1]),reshape(S_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');
% correl(3,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(SR_model_err,[NoC*NoC 1]),reshape(S_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');

% correl(1,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(S_model_err,[NoC*NoC 1]),[reshape(R_model_err,[NoC*NoC 1]) reshape(SR_model_err,[NoC*NoC 1])],'type','Spearman','rows','complete');
% correl(2,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(R_model_err,[NoC*NoC 1]),[reshape(S_model_err,[NoC*NoC 1]) reshape(SR_model_err,[NoC*NoC 1])],'type','Spearman','rows','complete');
% correl(3,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(SR_model_err,[NoC*NoC 1]),[reshape(S_model_err,[NoC*NoC 1]) reshape(R_model_err,[NoC*NoC 1])],'type','Spearman','rows','complete');

% correl(1,time)=corr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(S_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');
% correl(2,time)=corr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(R_model_cor,[NoC*NoC 1]),'type','Spearman','rows','complete');

% correl(1,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(S_model_cor,[NoC*NoC 1]),[reshape(R_model_cor,[NoC*NoC 1])],'type','Spearman','rows','complete');
% correl(2,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(R_model_cor,[NoC*NoC 1]),[reshape(S_model_periph_cor,[NoC*NoC 1])],'type','Spearman','rows','complete');
 
% cross datasets
% correl(1,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(S_model_cor,[NoC*NoC 1]),[reshape(R_model_cor,[NoC*NoC 1]) reshape(S_model_periph_cor,[NoC*NoC 1])],'type','Spearman','rows','complete');
% correl(2,time)=partialcorr(reshape(MEG_RDM_err(:,:,time),[NoC*NoC 1]),reshape(R_model_cor,[NoC*NoC 1]),[reshape(S_model_periph_cor,[NoC*NoC 1]) reshape(S_model_periph_cor,[NoC*NoC 1])],'type','Spearman','rows','complete');
...
legend ([plots(1) plots(2)],{'Stim-Coding','Rule-Coding'})
...
for time=1:length(Times)
    for region=regions_order_to_read
        ...
        Correlations(time,region)=corr(RDM_MEG,RDM_fMRI,'type','Spearman');
        
        
        Correlations_all_out(time,region)=partialcorr(RDM_MEG,RDM_fMRI,[RDM_model_Stim RDM_model_Rule],'type','Spearman');
        Correlations_all_expt_rule_out(time,region)=partialcorr(RDM_MEG,RDM_fMRI,RDM_model_Stim,'type','Spearman');
        Correlations_all_expt_stim_out(time,region)=partialcorr(RDM_MEG,RDM_fMRI,RDM_model_Rule,'type','Spearman');
...
xlabel('Time (ms)')
ylabel('Spearman''s correlation (\rho)')
box off
set(gca,'FontSize',18)
legend(Regions)
...
for time=1:length(Times)
    for region=regions_order_to_read
        ...
        rMEG_MRIall = correlate([yMEG xMRI xstim xrule],'type','spearman','method','semipartialcorr');
        rMEG_MRIrule = correlate([yMEG xMRI xrule],'type','spearman','method','semipartialcorr');
        rMEG_MRIstim = correlate([yMEG xMRI xstim],'type','spearman','method','semipartialcorr');
